...
import mods.quantumCraft.items.CrystalShovel;
import mods.quantumCraft.items.CrystalSword;
import mods.quantumCraft.items.ItemCrystal;
import mods.quantumCraft.items.ItemEnergyPacket;
import mods.quantumCraft.items.ItemPlutoniumIngot;
import mods.quantumCraft.items.ItemQDust;
import mods.quantumCraft.machine.BlockMachine;
import mods.quantumCraft.machine.ExtractorContainer;
import mods.quantumCraft.machine.InfuserContainer;
import mods.quantumCraft.machine.TileEntityExtractor;
...
public class Initializator implements IGuiHandler {
	...
	public static void initItems() {
		...
		ItemRadioactiveMeat = new mods.quantumCraft.items.RadioactiveMeat(
