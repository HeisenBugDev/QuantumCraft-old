...
public class QuantumCraftSettings {
	...
	public static void getConfig(Configuration config) {
		...
		InfusedCrystalPickaxeID = config.get("Items",
				"InfusedCrystalPickaxeID", 4517).getInt();
		InfusedCrystalSwordID = config.get("Items", "InfusedCrystalSwordID",
				4518).getInt();
		InfusedCrystalAxeID = config.get("Items", "InfusedCrystalAxeID", 4519)
				.getInt();
		InfusedCrystalShovelID = config.get("Items", "InfusedCrystalShovelID",
				4520).getInt();

		PlutoniumDustID = config.get("Items", "PlutoniumDustID", 4521).getInt();
		...
		witheringTimeout = config.get("ToolStuff", "WitheringTimeout", 100)
				.getInt();
