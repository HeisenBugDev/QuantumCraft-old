...
public class CraftingManager {
	...
	public static void addCrafting()
	{
		...
		GameRegistry.addRecipe(new ItemStack(ItemInitializator.DecoBlocks,9,5), "xx", "xx", 'x', new ItemStack(ItemInitializator.DecoBlocks,1,0));
		GameRegistry.addRecipe(new ItemStack(ItemInitializator.DecoBlocks,9,6), "xx", "xx", 'x', new ItemStack(ItemInitializator.DecoBlocks,1,1));
		GameRegistry.addRecipe(new ItemStack(ItemInitializator.DecoBlocks,9,7), "xx", "xx", 'x', new ItemStack(ItemInitializator.DecoBlocks,1,2));
		GameRegistry.addRecipe(new ItemStack(ItemInitializator.DecoBlocks,9,8), "xx", "xx", 'x', new ItemStack(ItemInitializator.DecoBlocks,1,3));
		GameRegistry.addRecipe(new ItemStack(ItemInitializator.DecoBlocks,9,9), "xx", "xx", 'x', new ItemStack(ItemInitializator.DecoBlocks,1,4));
		
		GameRegistry.addRecipe(new ItemStack(ItemInitializator.DecoBlocks,9,10), "xx", "xx", 'x', new ItemStack(ItemInitializator.DecoBlocks,1,5));
		GameRegistry.addRecipe(new ItemStack(ItemInitializator.DecoBlocks,9,11), "xx", "xx", 'x', new ItemStack(ItemInitializator.DecoBlocks,1,6));
		GameRegistry.addRecipe(new ItemStack(ItemInitializator.DecoBlocks,9,12), "xx", "xx", 'x', new ItemStack(ItemInitializator.DecoBlocks,1,7));
		GameRegistry.addRecipe(new ItemStack(ItemInitializator.DecoBlocks,9,13), "xx", "xx", 'x', new ItemStack(ItemInitializator.DecoBlocks,1,8));
		GameRegistry.addRecipe(new ItemStack(ItemInitializator.DecoBlocks,9,14), "xx", "xx", 'x', new ItemStack(ItemInitializator.DecoBlocks,1,9));
